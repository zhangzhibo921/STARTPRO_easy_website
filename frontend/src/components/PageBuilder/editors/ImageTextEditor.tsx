...
const ImageTextEditor: React.FC<ImageTextEditorProps> = ({ imageWidthPercent, onWidthChange }) => {
    ...
    <div className="mb-6 bg-theme-surface p-4 rounded-lg border border-theme-divider space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-theme-textSecondary">拖动调整图片在容器中的占比，默认占满。</p>
        </div>
      </div>

      <div className="space-y-2">
        <div className="flex items-center justify-between text-sm">
          <span className="text-theme-textPrimary">宽度百分比</span>
